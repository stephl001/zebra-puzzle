...
//     OwnerNationality Englishman
//     ``The Spaniard owns the dog``
//     ``The Ukrainian drinks tea``
//     OwnerNationality Norwegian
//     ``The Japanese smokes Parliaments``
// ]
//
// let permute list =
...
//     lockProperties (OwnerCigaretteBrand OldGold) (OwnerPet Snails)
//
// let ``Milk is drunk in the middle house`` =    
//     lockProperties (OwnerDrink Milk) (Position Middle)
//
// let ``The Norwegian lives in the first house`` =
//     lockProperties (OwnerNationality Norwegian) (Position First)
//
...
//     lockProperties (OwnerCigaretteBrand LuckyStrike) (OwnerDrink OrangeJuice)
//
// let ``The Norwegian lives next to the blue house`` =
//     siblingProperties (OwnerNationality Norwegian) (Color Blue)
//
// let statements = [
//     ``The Englishman lives in the red house``
//     ``The Spaniard owns the dog``
